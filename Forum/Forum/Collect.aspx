<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Collect.aspx.cs" Inherits="Forum.Collect" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cen" runat="server">
    <div style="margin-bottom: 15px; margin-top: -10px;">
        <label class="label label-info" style="padding: 10px 10px;">The list of post</label>
    </div>
    <div>
        <ul class="list">
            <%
